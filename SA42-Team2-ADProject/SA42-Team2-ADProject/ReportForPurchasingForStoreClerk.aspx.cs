...
namespace ADProject
{
    public partial class ReportForPurchasingForStoreClerk : System.Web.UI.Page
    {
        ReportBL reportBl;
        ...
        private void LoadReport(DateTime fromDate, DateTime toDate)
        {
            ...
            t.Columns.Add("EmployeeName", Type.GetType("System.String"));
            DataRow r;
            ...
            foreach(PurchasingOrder po in poList)
            {
                ...
                foreach(PurchasingOrderDetail poDetail in detailInpo)
                {
                    ...
                    r["EmployeeName"] = po.Employee.EmployeeName;
                    t.Rows.Add(r);
                }
            }
